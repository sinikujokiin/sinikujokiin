	...
	<div class="row">
		<div class="col-12">
	        ...
	        <form id="form">
                ...
                <div id="preview-ikon" class="mb-3"><span class="<?= $data->ikon ?> fa-5x"></span></div>
					      <input type="text" name="ikon" class="form-control"  id="ikon" value="<?= $data->ikon ?>" placeholder="fa fa-home">
					  ...
					  <div class="col-12">
					    <div class="form-group">
					      ...
					      <input type="hidden" name="id_tugas" id="id_tugas" value="<?= encrypt_decrypt("encrypt", $data->id_tugas) ?>">
					      <input type="text" name="nama_tugas" class="form-control" id="nama_tugas" value="<?= $data->nama_tugas ?>" placeholder="nama tugas">
					  ...
					  <div class="col-12">
					    <div class="form-group">
					      ...
					      <textarea name="deskripsi_singkat" id="deskripsi_singkat" placeholder="deskripsi singkat" class="form-control"><?= $data->deskripsi_singkat ?></textarea>
					  ...
					  <div class="col-12">
					    ...
					    <div class="form-group">
					      ...
					      <textarea name="deskripsi" id="deskripsi" placeholder="deskripsi lengkap" class="form-control"><?= $data->deskripsi ?></textarea>
					      <span class="deskripsi_error text-danger"></span><br>
					      <small><b>Word Count : </b><b id="sum-count"><?= str_word_count(strip_tags($data->deskripsi)) ?></b></small>
					    </div>
					  </div>
					</div>
				</div>
...
<script>
	...
	function uploadImage(image) {
      ...
      $('.btn-submit').click(function(e){
	    ...
	    $.ajax({
	      url:base_url+'cms/save-tugas/ubah',
	      dataType:'json',
	      type:'POST',
	      data: formData,
	      contentType: false,
