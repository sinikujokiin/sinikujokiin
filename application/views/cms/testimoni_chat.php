...
<script>
  ...
  function loadProduct()
  {
    dt = $("#dt-kategori").DataTable({
      ...
      "autoWidth": false,
        ...
        "destroy":true,
        "ajax": {
          "url":base_url+"cms/get-data-testimoni-chat",
          "type": "POST",
        },
        "columnDefs": [
        {
  ...
  $('.btn-submit').click(function(e){
    ...
    $.ajax({
      url:base_url+'cms/save-testimoni-chat/'+aksi,
      dataType:'json',
      type:'POST',
      data: formData,
      contentType: false,
  ...
  function ButtonEdit(id)
  {
    ...
    $.ajax({
      url:base_url+'cms/get-data-testimoni-chat/'+id,
      dataType:'json',
      success: (response) => {
  ...
  {
      $.ajax({
        url:base_url+'cms/update-status-testimoni-chat/'+id,
        type:'post',
        dataType:'json',
        success: (response) => {
          sukses(response.alert);
  ...
  function ButtonDelete(id)
  {
    Swal.fire({ 
      ...
      if (result.value) {
          $.ajax({
            url:base_url+'cms/delete-testimoni-chat/'+id,
            type:'post',
            dataType:'json',
            success: (response) => {
              sukses(response.alert);
